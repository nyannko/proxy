...
# without tor
go_means, go_std = (907.8, 940.4, 1164.5, 1190.72727273, 1713.47826087, 1345.7, 1351.71428571), (
4.83321838944, 74.1082991304, 87.1105619314, 95.234608929, 70.912860982, 10.9731490467, 22.0013914217)
in_means, in_std = (1220.3, 1261.2, 1436.1, 1345.35714286, 2399.29166667, 1677.7, 1703.6), (
4.36004587132, 8.2316462509, 20.2556165051, 100.620295555, 82.237189148, 87.494056941, 101.726299451)
tw_means, tw_std = (1967.7, 2000.0, 2140.7, 2379.52, 2982.34782609, 2402.1, 2575.1), (
39.2302179448, 27.0333127826, 20.6835683575, 95.65358373, 99.22545887, 41.9200429389, 444.320031059)
fb_means, fb_std = (2203.1, 2223.5, 2506.9, 2885.26666667, 3379.45454545, 2770.7, 2730.2), (
74.0060132692, 59.6192083141, 129.279890161, 94.692729434, 201.8975274, 155.006483735, 28.6803068324)
yt_means, yt_std = (2968.5, 3032.5, 3188.9, 3223.95454545, 4129.55, 3286.8, 3302.3), (
67.970949677, 96.575618041, 106.367711266, 126.683094223, 153.225882366, 69.4705693082, 75.6479345389)
...
for x, y in zip(yvars_axis, yvars):
    ...
    ax.set_xticks(ind)
    # ax.set_xticklabels(('Shadowsocks', 'V2Ray', '', 'MultiProxy', '', 'OpenVPN', 'OpenConnect', 'Tor'),fontsize=8)
    ax.set_xticklabels(('Shadowsocks', 'V2Ray', '', 'MultiProxy', '', 'OpenVPN', 'OpenConnect'), fontsize=8)
    ax.legend()
